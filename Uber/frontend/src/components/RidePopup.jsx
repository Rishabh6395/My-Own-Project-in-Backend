  ...
  return (
    <div>
      ...
      <div className='flex gap-2 mt-4 justify-between flex-col items-center'>
        ...
        className=' mt-1 bg-gray-300  px-10 text-gray-700 font-semibold p-3  rounded-lg'>Ignore</button>

          <button 
        onClick={() => {
          props.setConfirmRidePopupPanel(true)
        }}
        className='  bg-green-600  px-10 text-white font-semibold p-3  rounded-lg'>Accept</button>
