...
const CaptainHome = () => {
  ...
  return (
    <div className='h-screen'>
          <div className='fixed p-3 top-0 mt-6 flex items-center justify-center'>
            <img className='w-16 ' src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Uber_logo_2018.png" alt="" />
            <Link to='/home' className='fixed right-2 top-0 mt-6 h-10 w-10 bg-white flex items-center justify-center rounded-full'>
