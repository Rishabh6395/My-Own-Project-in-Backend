     ...
     <div>
      ...
      <div className='flex items-center justify-between gap-5 p-3 border-b-2'>
        ...
        <div className='text-right'>
          <h2 className='font-semibold text-lg'>{props.ride?.captain.fullname.firstname}</h2>
          <h4 className='font-semibold -mt-1 -mb-1 text-xl'>{props.ride?.captain.vehicle.plate}</h4>
          <p className='text-sm text-gray-600'>Maruti Suzuki</p>
          <h3 className='text-xl font-semibold'>{props.ride?.otp}</h3>
        </div>
      </div>
